...
namespace Voltash\UploadBundle\Services\PHPImageWorkshop\Core\Exception;

use Voltash\UploadBundle\Services\PHPImageWorkshop\Exception\ImageWorkshopBaseException as ImageWorkshopBaseException;
